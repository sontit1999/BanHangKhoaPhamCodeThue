...
public class TraSuaActivity extends AppCompatActivity {
   ...
   public TraSuaActivity(){

   }
    public TraSuaActivity(Context applicationContext, ArrayList<Sanpham> mangts) {
    ...
    private void GetData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongdan,
                        ...
                        if(response != null && response.length() != 2){
                            ...
                            try {
                                ...
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    TraSuaActivity traSuaActivity = null;
                                    traSuaActivity.notifyDataSetChanged();
                                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError { //day du lieu len
                ...
                param.put("idsanpham",String.valueOf(idts)); //key de giong trong file getsanpham.php
                return param;
            }
        };
    ...
    private void anhxa() {
        toolbarts = findViewById(R.id.toolbartrasua);
        lvts = findViewById(R.id.listviewtrasua);
        mangts = new ArrayList<>();
        traSuaAdapter = new TraSuaActivity(getApplicationContext(),mangts);
       // lvts.setAdapter((ListAdapter) traSuaAdapter);
