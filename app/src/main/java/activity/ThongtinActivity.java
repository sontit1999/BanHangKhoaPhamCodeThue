...
public class ThongtinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng nhacuaDuk = new LatLng(10.806099, 106.628833);
        mMap.addMarker(new MarkerOptions().position(nhacuaDuk).title("Đại học công nghiệp thực phẩm").snippet("140 Lê Trọng Tấn").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(nhacuaDuk).zoom(90).build();
